export const CONFIG = {
  ...
  EXTREME: {
    ...
    FOG_INTERVAL_MIN: 5000,
    FOG_INTERVAL_MAX: 8000,
    FOG_DURATION: 3300,
    FOG_MAX_ALPHA: 0.44,
    STORM_INTERVAL_MIN: 9000,
    STORM_INTERVAL_MAX: 14000,
    STORM_DURATION: 4200,
    STORM_SYNC_MS: 200,
    RAIN_PARTICLE_COUNT: 4,
    RAIN_SPAWN_MS: 40,
    LIGHTNING_MIN_MS: 600,
    LIGHTNING_MAX_MS: 1400,
    LIGHTNING_CHANCE: 0.5,
    LIGHTNING_FLASH_MS: 90,
    DOOR_WINDOW_MS: 5000,
    DOOR_OPEN_MS: 1050,
    ...
    CLOSE_MS: 550,
    CLOSE_START_GAP: 430,
    CLOSE_MIN_RATIO_MIN: 0.65,
    CLOSE_MIN_RATIO_MAX: 0.85,
